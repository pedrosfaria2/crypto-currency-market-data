...
class TestConfig(unittest.TestCase):
    def test_database_url(self):
        """
        Test to ensure that the DATABASE_URL environment variable is not None.
        ...
        value is None, it indicates a misconfiguration or missing environment variable.
        """
        self.assertIsNotNone(Config.DATABASE_URL, "DATABASE_URL should not be None")

    def test_api_url(self):
        """
        Test to ensure that the API_URL environment variable is not None.
